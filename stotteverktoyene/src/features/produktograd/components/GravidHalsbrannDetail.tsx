...
const MEDICINES: Medicine[] = [
  {
    name: "Gaviscon",
    form: "Munnoppløsning/tablett",
    type: "Antacida",
    usage: "yes",
    usageLabel: "Ja",
    comment: "Danner beskyttende lag over magesyre og reduserer refluks.",
    priority: "first",
  ...
  },
  {
    ...
    usage: "yes",
    usageLabel: "Ja",
    comment: "Syrenøytraliserende middel. Godt dokumentert i graviditet.",
    priority: "second",
    priorityLabel: "Andrevalg",
  },
  {
    name: "Pepcid (famotidin)",
    form: "Tablett",
    type: "H2-blokker",
    usage: "caution",
    usageLabel: "Etter vurdering",
    comment: "Reduserer syreproduksjonen. Brukes etter råd fra lege.",
    priority: "need",
  ...
  },
  {
    ...
    comment: "Syrehemmende middel. Brukes ved behov.",
    priority: "doctor",
